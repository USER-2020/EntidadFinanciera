 ...
 */
public class PortalClientes extends javax.swing.JFrame {

    /**
     * Creates new form PortalClientes
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Portal Clientes");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Menu"));
        jPanel1.setLayout(new java.awt.GridLayout(4, 1, 0, 6));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PortalClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PortalClientes().setVisible(true);
            }
        });
    }
